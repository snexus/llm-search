...
def get_nodes_from_documents(
    document_paths: List[Path], chunk_parser: Callable[[Path], List[str]]
) -> List[Node]:
...
def get_documents_from_langchain_splitter(
    document_paths: List[Path], splitter
) -> List[Node]:
    """Gets list of nodes from a collection of documents
...
def get_documents_from_custom_splitter(
    document_paths: List[Path], splitter_func, max_size
) -> List[Node]:
    """Gets list of nodes from a collection of documents
